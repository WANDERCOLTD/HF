...
export async function PATCH(
  ...
  try {
    ...
    // onboardingFlowPhases mutations trigger fan-out (it's in
    // COMPOSE_AFFECTING_KEYS); offboarding-only mutations do not.
    try {
      await updatePlaybookConfig(courseId, (pbConfig) => {
