...
import { execute as executeMarkComplete } from "./wizard-tool-executor/tools/mark_complete";
import { execute as executeSuggestWelcomeMessage } from "./wizard-tool-executor/tools/suggest_welcome_message";
import { execute as executeCreateInstitution } from "./wizard-tool-executor/tools/create_institution";
import { execute as executeUpdateCourseConfig } from "./wizard-tool-executor/tools/update_course_config";
import { execute as executeUpdateSetup } from "./wizard-tool-executor/tools/update_setup";
import { execute as executeCreateCommunity } from "./wizard-tool-executor/tools/create_community";
import { execute as executeCreateCourse } from "./wizard-tool-executor/tools/create_course";
